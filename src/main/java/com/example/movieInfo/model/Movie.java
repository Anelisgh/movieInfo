...
public class Movie {
    ...
    public Movie(String title, String description, Integer releaseYear, Genre genre, Director director, List<Review> reviews, Set<Watchlist> watchlists, Set<Actor> actors) {
        this.title = title;
